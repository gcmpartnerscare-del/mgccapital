...
import SeeOurImpact from "../components/about/SeeOurImpact";
// import HybridFAQ from "../components/HybridFAQ";
import BlogSection from "../components/BlogSection";
import Testimonials from "../components/Testimonials";
import ApplicationSteps from "../components/ApplicationSteps";

const About = ( { abtBtnpath = "/about#seeourimpact",
  abtBtnContent = "See Our Impact",}) => {
  const aboutStats = [
    {
  ...
  return (
    <>
      ...
      <Element
        name="whoweare"
        className="py-20 px-4 md:px-10 bg-white text-primary-900 relative overflow-hidden"
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-36 lg:gap-12 items-center">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://img.freepik.com/premium-photo/excited-young-travelers-modern-hotel-lobby-their-vacation-getaway_1192423-3390.jpg?uid=R110204670&ga=GA1.1.302447274.1684498652&semt=ais_hybrid&w=740&q=80')",
            }}
          >
            <ul
              className="absolute 
